...
In its simplest form, Crowdfunding is a practice of giving monetary funds to<br></br> overcome specific social, cultural, or economic hurdles individuals face in their<br></br> daily lives.<br></br>
  ...
  <div  className="accordion-item">
    ...
    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      ...
      To Start a Fundraiser, follow the three steps:<br></br>
1.Open the "Fundraiser" option<br></br>
2. Fill up the form<br></br>
3. Hit Submit<br></br>
      </div>
    </div>
  </div>
  ...
  <div className="accordion-item">
    ...
    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      <div className="accordion-body">
      With HealtHelp, the money you collect goes directly to the bank account associated with your fundraising page. Raising money for yourself or anyone has never been easier.
      </div>
    </div>
  </div>
  <div className="accordion-item">
    ...
    <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
      <div className="accordion-body">
      Your HealtHelp fundraiser features the very best in secure payment encryption technology. Not only are your donors online payments safe, your money is stored securely until you're ready to request a withdrawal via electronic bank transfer.
      </div>
    </div>
  </div>
  <div className="accordion-item">
...
To know more about transactional processing fee, visit: www.ketto.org/support/plans-and-pricing
  ...
  <div className="accordion-item">
    ...
    <div id="collapseSix" className="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
      <div className="accordion-body">
      You can write to info@ketto.org Know someone who needs funds for medical treatment urgently? Help them out by sharing this information with them.
      </div>
    </div>
  </div>
