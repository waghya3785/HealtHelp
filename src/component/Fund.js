                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            ...
                            <div className="card-group">
                                <div className="card mx-2 bg-secondary p-2 text-dark bg-opacity-10">
                                <img src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxhUubLP9MxqRn5WyTihFEIR4UWvLDN9L7lA&usqp=CAU"} className="d-block w-100" alt="..." />                                    <div className="card-body">
