...
export default function Donate() {
  ...
  return (
    ...
    <div className="container">
          ...
          <h1 className='card-title justify-content-center' style={{marginLeft:"500px"}}>Why to donate</h1>
        ...
        <div className="carousel-inner">
          <div className="carousel-item active" >
            <img src={D1} className="d-block w-100" alt="..." style={{ borderRadius: "15px", boxShadow: "2px 2px 6px", height: "75%", width: "75%", margin: "auto" }} />
          ...
          <div className="carousel-item">
            <img src={D2} className="d-block w-100" alt="..." style={{ borderRadius: "15px", boxShadow: "2px 2px 6px", height: "75%", width: "75%", margin: "auto" }} />
            <div className="carousel-caption d-none d-md-block">
          ...
          <div className="carousel-item">
            <img src={D3} className="d-block w-100" alt="..." style={{ borderRadius: "15px", boxShadow: "2px 2px 6px", height: "75%", width: "75%", margin: "auto" }} />
            <div className="carousel-caption d-none d-md-block">
      ...
      <div className="row row-cols-1 row-cols-md-3 g-4 " style={{ margin: "85px 0px" }} >
        <div className="col d-flex justify-content-center">
          <div className="card" style={{ borderRadius: "15px", boxShadow: "2px 2px 6px" }}>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3lmVpFe5cwFoXLp_8D0hINrBLw0fjrWbjTQ&usqp=CAU" className="card-img-top" alt="..." style={{ borderRadius: "15px", height: "250px" }} />
        ...
        <div className="col">
          <div className="card" style={{ borderRadius: "15px", boxShadow: "2px 2px 6px" }}>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTbQtLL9NwNl8PZTV3WTs10WrutuQqXQCq9w&usqp=CAU" className="card-img-top" alt="..." style={{ borderRadius: "15px", height: "250px" }} />
            <div className="card-body">
        ...
        <div className="col">
          <div className="card" style={{ borderRadius: "15px", boxShadow: "2px 2px 6px" }}>
            <img src="https://images.newindianexpress.com/uploads/user/imagelibrary/2020/8/24/w900X450/Bagalkot_village_school_EPS.jpg?w=400&dpr=2.6" className="card-img-top" alt="..." style={{ borderRadius: "15px", height: "250px" }} />
            <div className="card-body">
      ...
      <div className="row row-cols-1 row-cols-md-3 g-4 justify-content-center">
        <div className="col">
          <div className="card mx-3" style={{ borderRadius: "15px", boxShadow: "2px 2px 6px" }}>
            <img src="https://switchindia.org/images/work/pediatric-health-camp-neral02.jpg" className="card-img-top" alt="..."  style={{ borderRadius: "15px", height: "250px" }} />
            <div className="card-body">
        ...
        <div className="col">
          <div className="card" style={{ borderRadius: "15px", boxShadow: "2px 2px 6px" }}>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWA5nWCUkKy_4YwRv04lJ38gqZsg719n-7dw&usqp=CAU" className="card-img-top" alt="..." style={{ borderRadius: "15px", height: "250px" }} />
            <div className="card-body">
